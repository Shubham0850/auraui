...
const style = {
  ...
  gridContainer: "grid items-stretch grid-cols-1 gap-y-12 lg:grid-cols-12 gap-x-16",
  ...
  phasesGrid: "grid grid-cols-1 gap-12 mt-12 sm:grid-cols-2 sm:mt-16 xl:gap-x-16",
