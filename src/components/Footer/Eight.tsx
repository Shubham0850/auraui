			...
			<div className="px-6 mx-auto sm:px-8 lg:px-12 max-w-7xl">
				<div className="grid grid-cols-1 gap-y-12 lg:grid-cols-7 gap-x-8">
					<div className="lg:col-span-3">
						...
						<p className="max-w-xs mt-4 font-sans text-sm font-normal text-opacity-50 text-white">Aliquam at in habitasse dictum turpis ultricies dictum. Praesent cursus tristique erat magna enim enim.</p>
					</div>

					<div className="lg:col-span-2">
						<div className="grid grid-cols-2 gap-x-8">
							<div>
								<h6 className="font-serif text-lg font-semibold text-white">Courses</h6>
							...
							<div>
								<h6 className="font-serif text-lg font-semibold text-white">Legals</h6>
					...
					<div className="lg:col-span-2">
						<h6 className="font-serif text-lg font-semibold text-white">Lorem</h6>
						<p className="mt-4 font-sans text-sm font-normal text-opacity-50 text-white">Commodo augue cras facilisis viverra ut egestas mauris tellus viverra. Nam sed risus ornare lacinia eu.</p>
					</div>
				</div>
				...
				<div className="mt-12 sm:flex sm:items-center sm:justify-between">
					...
					<p className="mt-6 font-sans text-sm font-normal text-center text-opacity-50 sm:mt-0 sm:text-left sm:order-1 text-white">Copyright ©2022 BakerStreet School</p>
				</div>
			</div>
		</footer>
