...
const SmallFooter = (props: Props) => {
  ...
  const anchorStyles = "text-sm text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80";
        ...
        <div className="text-center xl:flex xl:items-center xl:justify-between xl:text-left">
          ...
          <div className="items-center mt-8 xl:mt-0 xl:flex xl:justify-end xl:space-x-8">
            <ul className="flex flex-wrap items-center justify-center gap-x-8 gap-y-3 xl:justify-end">
              ...
              <li>
                <a href="#" title="Services" className={anchorStyles}>Services</a>
              </li>
              <li>
              ...
              <li>
                <a href="#" title="Support" className={anchorStyles}>Support</a>
              </li>
            </ul>
