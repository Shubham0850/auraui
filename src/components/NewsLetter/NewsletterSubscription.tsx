...
const style = {
  ...
  gridContainer: "grid items-center max-w-5xl grid-cols-1 mx-auto lg:grid-cols-2 gap-y-12 lg:gap-x-24",
  textContainer: "lg:order-2 text-center lg:text-left",
  title: "text-base font-semibold text-blue-600",
  headline: "mt-6 text-3xl font-semibold tracking-tight text-gray-900 sm:text-4xl lg:text-5xl lg:mt-8",
  ...
  input: "block w-full px-6 py-4 text-base font-normal text-gray-900 placeholder-gray-500 bg-transparent border border-gray-300 rounded-xl focus:outline-none sm:border-transparent focus:border-blue-500  sm:focus:ring-0 sm:focus:border-transparent",
  button: "inline-flex items-center justify-center w-full px-6 py-4 mt-4 text-base font-medium transition-all duration-200 border rounded-lg border-transparent sm:mt-0 sm:w-auto text-white focus:outline-none focus:ring-2 focus:ring-offset-2 bg-blue-600 hover:bg-blue-700 focus:ring-blue-700",
          ...
          <div className={style.textContainer}>
            ...
            <div className={style.subscribers}>
              ...
              <p className={style.subscriberText}>
                <span className={style.strongText}>Over 20K professionals</span><br /> have already subscribed
              </p>
            </div>
          </div>
