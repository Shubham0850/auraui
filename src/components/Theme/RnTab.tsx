...
const IPhoneMockup: React.FC<{ imageUrl: string }> = ({ imageUrl }) => {
	return (
		<div className="border-4 border-gray-100 dark:border-customDark shadow-2xl rounded-3xl overflow-hidden max-w-xs mx-auto relative bg-black">
			...
			<div>
				<img src={imageUrl} alt="iPhone 15 Pro Max Screenshot" className="w-full" />
			</div>
		</div>
	);
};
...
const tabs = [
	{
		...
		label: "Android",
		icon: <FaAndroid />,
		component: <AndroidMockup imageUrl={"https://itc.ua/wp-content/uploads/2023/10/IMG_0262.jpeg"} />,
	},
	{
		name: "ios",
		label: "iOS",
		icon: <FaApple />,
		component: <IPhoneMockup imageUrl={"https://itc.ua/wp-content/uploads/2023/10/IMG_0262.jpeg"} />,
