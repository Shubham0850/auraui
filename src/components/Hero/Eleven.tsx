	...
	return (
		<div className="relative pt-48 pb-12 overflow-hidden bg-black xl:pt-60 sm:pb-16 lg:pb-32 xl:pb-48 2xl:pb-56">
			...
			<div className="absolute inset-y-0 right-0">
				<img className="object-cover w-full h-full max-w-4xl origin-left opacity-50 xl:opacity-100 lg:scale-110 lg:-translate-x-8" src="https://cdn.rareblocks.xyz/collection/bakerstreet/images/hero/5/background.png" alt="" />
			</div>
			...
			<div className="relative">
				<div className="px-6 mx-auto sm:px-8 lg:px-12 max-w-7xl">
					<div className="w-full text-right lg:w-2/3 xl:w-1/2 md:text-left">
						...
						<p className="mt-12 font-sans text-base font-normal leading-7 md:max-w-sm text-white text-opacity-70">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Eu penatibus pellentesque dolor consequat ligula egestas massa gravida. Porttitor venenatis enim praesent.</p>
