...
function Nft12() {
    ...
    <div class="absolute inset-0">
        <img class="object-cover w-full h-full" src="https://landingfoliocom.imgix.net/store/collection/niftyui/images/hero-single/3/background.png" alt="" />
    </div>
            ...
            <nav class="flex items-center justify-between">
                ...
                <div class="hidden md:flex">
                    <a
                        href="#"
                        title=""
                        class="inline-flex items-center justify-center px-4 py-2 text-base font-semibold text-white transition-all duration-200 bg-gray-900 border border-gray-800 rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 hover:bg-gray-700"
                        role="button"
                    >
                        Connect Wallet
                    </a>
    ...
    <section class="relative py-12 sm:py-16 lg:pb-20 xl:pb-24">
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="max-w-lg mx-auto text-center">
                <h1 class="text-4xl font-bold text-gray-900 uppercase sm:text-5xl lg:text-6xl">Welcome to Funny Ape Club</h1>
                <p class="mt-6 text-lg font-normal text-gray-600 lg:text-xl">Fuape is a collection of 1000 funny ape NFTs - unique digital collectibles living on the Ethereum blockchain.</p>

                <div class="flex flex-col px-12 mt-10 space-y-5 sm:px-0 sm:space-y-0 sm:space-x-5 sm:flex-row sm:items-center sm:justify-center">
                    <a
                        href="#"
                        title=""
                        class="inline-flex items-center justify-center px-8 py-3 text-base font-semibold text-gray-900 transition-all duration-200 border border-gray-900 rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 hover:bg-gray-900 hover:text-white"
                        role="button"
                    >
                        Join Discord
                    </a>
                    ...
                    <a
                        href="#"
                        title=""
                        class="relative inline-flex items-center justify-center py-3 pl-16 pr-8 text-base font-bold text-white transition-all duration-200 bg-gray-900 border border-gray-900 rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 hover:bg-gray-700"
                        role="button"
                    >
                        <div class="absolute inset-y-0 left-0 flex items-center pl-4">
                            <svg class="w-8 h-8" viewBox="0 0 90 90" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <path
    ...
    <img class="object-bottom w-full h-full mx-auto" src="https://landingfoliocom.imgix.net/store/collection/niftyui/images/hero-single/3/images.png" alt="" />
</div>
