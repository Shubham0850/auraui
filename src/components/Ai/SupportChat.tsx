...
const SupportChat = () => {
  ...
  return (
    <div className="relative bg-white h-screen">
      <div>
        <button
          className="absolute bottom-4 right-4 inline-flex items-center justify-center text-sm font-medium disabled:pointer-events-none disabled:opacity-50 border rounded-full w-16 h-16 bg-black  m-0 cursor-pointer border-gray-200 p-0 normal-case leading-5 hover:text-gray-900"
          type="button"
          onClick={toggleChat}
        >
          <ChatIcon className="text-gray-600 block border-gray-200 align-middle" />
        </button>
