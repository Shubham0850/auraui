      ...
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="max-w-2xl text-center sm:text-left">
          <h2 className="text-3xl font-bold text-gray-900 sm:text-4xl xl:text-5xl font-pj">
            Try Rareblocks for 30 days, completely free. No credit card
            required.
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 px-12 mt-8 text-center sm:text-left sm:px-0 gap-x-12 gap-y-16 lg:mt-16 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <div className="flex items-end justify-center mt-6 sm:justify-start">
              <p className="text-5xl font-bold text-gray-900 font-pj">$99</p>
          ...
          <div>
            ...
            <div className="flex items-end justify-center mt-6 sm:justify-start">
              <p className="text-5xl font-bold text-gray-900 font-pj">$199</p>
              <p className="text-lg font-medium text-gray-400 font-pj">/mo</p>
            </div>
            ...
            <div className="relative inline-flex mt-10 group">
              ...
              <a
                ...
                className="
                            ...
                            font-pj
                            hover:bg-gray-700
                            focus:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900
                        "
                role="button"
              >
                Get 30 days free trial
