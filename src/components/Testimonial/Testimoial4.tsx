        ...
        <div className="grid items-center grid-cols-1 lg:grid-cols-2 gap-y-12 lg:gap-x-16 xl:gap-x-24">
          <div>
            <img
              ...
              src="https://landingfoliocom.imgix.net/store/collection/saasui/images/testimonial/3/woman-with-laptop-smiling.png"
              alt=""
            />
          </div>
          ...
          <div className="xl:pr-16">
            ...
            <div className="flex flex-wrap items-center gap-4 mt-6">
              ...
              <div className="inline-flex px-3 py-2 bg-white rounded-full">
                <img
                  className="w-auto h-7"
                  src="https://landingfoliocom.imgix.net/store/collection/saasui/images/testimonial/3/waverio.svg"
                  alt=""
                />
              </div>
            </div>
