        ...
        <div className="grid grid-cols-1 gap-y-12 lg:grid-cols-7 lg:gap-x-20">
          <div className="lg:col-span-3 lg:order-last">
            <div className="relative overflow-hidden">
              <img
                ...
                src="https://landingfoliocom.imgix.net/store/collection/dusk/images/features/11/woman.png"
                alt=""
              />
          ...
          <div className="lg:col-span-4">
            ...
            <p className="mt-8 text-lg font-normal text-gray-400">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vel diam
              in justo, amet ege stas facilisi sed quis duis. Velit bibendum
              nunc tellus ultrices. Aliquam laoreet neque nascetur lorem cursus.
              Adipiscing molestie elit at tortor libero integer tristique id
              ante.
            </p>
