        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-x-24 gap-y-16 xl:gap-x-36">
          <div>
            ...
            <p className="mt-6 font-sans text-lg font-normal leading-8 text-opacity-50 lg:mt-8 text-white">
              ...
              nulla maecenas nulla consectetur erat.
            </p>
            <div className="mt-8">
              <a
                href="#"
            ...
            <ul className="space-y-8">
              <li>
                <h3 className="font-sans text-2xl font-normal text-white">
                  Beginner and Pro levels
                </h3>
                <p className="mt-3 font-sans text-lg font-normal leading-8 text-opacity-50 text-white">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla
                  ornare ut a felis ornare sapien purus.
                </p>
              </li>
        ...
        <div className="relative mt-16 group">
          <div className="overflow-hidden rounded-lg aspect-w-16 aspect-h-9">
            <img
              ...
              src="https://cdn.rareblocks.xyz/collection/bakerstreet/images/features/3/video-thumbnail.png"
              alt=""
            />
          </div>
