        ...
        <div className="grid grid-cols-1 lg:grid-cols-7 gap-x-20 gap-y-12">
          <div className="lg:order-2 lg:col-span-4">
            <div className="max-w-lg lg:max-w-none">
              <h2 className="text-3xl font-semibold tracking-tight text-gray-900 sm:text-4xl lg:text-5xl lg:pr-8">
                Clarity is here to make life a little bit easier.
              </h2>
            ...
            <div className="grid grid-cols-1 gap-8 pt-8 mt-8 border-t border-gray-200 sm:grid-cols-2 md:mt-16 xl:mt-24">
              <div>
                ...
                <div className="mt-6">
                  <a
                    href="#"
                    title=""
                    className="text-sm font-semibold text-blue-600 transition-all duration-200 hover:text-blue-800 hover:underline"
                  >
                    {" "}
          ...
          <div className="grid p-12 bg-blue-100 lg:order-1 lg:col-span-3 rounded-3xl place-items-center">
            <img
              ...
              src="https://landingfoliocom.imgix.net/store/collection/saasui/images/features/1/feature-1.svg"
              alt=""
            />
          </div>
        </div>
