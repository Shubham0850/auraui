...
function Feature10() {
  return (
    <section className="lg:relative bg-black">
      <div className="w-full pt-16 mx-auto sm:pb-12 max-w-7xl lg:py-32 xl:py-48">
        <div className="px-6 lg:w-1/2 sm:px-8 lg:px-12">
          ...
          <p className="mt-6 font-sans text-base font-normal leading-7 text-opacity-50 lg:mt-8 text-white">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Amet,
            euismod nunc, morbi urna, volutpat pulvinar aliquet.
          </p>

          <ul className="mt-12 space-y-5 font-serif text-3xl italic tracking-tight lg:mt-16 text-white">
            <li className="flex items-center group">
              <div className="inline-flex items-center justify-center flex-shrink-0 w-16 h-16 mr-5 transition-all duration-300 rounded-full bg-dark-gray group-hover:bg-white group-hover:text-black text-white">
                <svg
                  className="w-6 h-6"
                  viewBox="0 0 24 24"
                  fill="currentColor"
              ...
              Videos lessons from professionals
            </li>
      ...
      <div className="relative w-full h-64 sm:h-72 md:h-96 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 lg:h-full">
        <img
          ...
          src="https://cdn.rareblocks.xyz/collection/bakerstreet/images/features/1/feature-image.png"
          alt=""
        />
        <img
          className="absolute inset-0 object-cover w-full h-full lg:hidden"
          src="https://cdn.rareblocks.xyz/collection/bakerstreet/images/features/1/feature-image-mobile.png"
          alt=""
        />
      </div>
    </section>
