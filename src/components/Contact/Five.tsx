...
<section className="relative py-12 overflow-hidden bg-black sm:py-16 lg:py-20 xl:py-24">
    <div className="absolute top-0 left-0 -translate-x-48 -translate-y-36">
        <svg className="blur-3xl filter" width="756" height="202" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M434.095 21.875c185.823 0 321.414-55.288 321.414 9.929S268.41 201.855 82.588 201.855c-185.822 0 0-104.834 0-170.051 0-65.217 165.685-9.929 351.507-9.929Z" fill="url(#b)" />
            <defs>
                <linearGradient id="b" x1="0" y1="201.855" x2="8.923" y2="-28.873" gradientUnits="userSpaceOnUse">
            ...
            <div className="lg:col-span-4">
                <form action="#" method="POST" className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <div className="sm:col-span-2">
                        <label htmlFor="" className="text-base font-normal text-white"> What kind of service are you looking for? </label>
                        <div className="mt-2">
                    ...
                    <div className="sm:col-span-2">
                        ...
                        <div className="mt-2">
                            <textarea name="" id="" placeholder="Write your message" rows={4} className="block w-full px-5 py-4 text-base font-normal text-white placeholder-gray-500 bg-black border border-gray-800 rounded-md resize-y focus:border-white focus:ring-white focus:ring-1"></textarea>
                        </div>
                    </div>
