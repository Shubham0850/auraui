    ...
    return (
        <div className="flex flex-col items-center">
            <div className="relative flex items-center bg-gray-200 dark:bg-customDark rounded-lg p-1">
                <button
                    ref={tabRefs.One}
                    className={`${TOGGLE_CLASSES} ${selected === "One" ? "text-black dark:text-white" : "text-gray-600 dark:text-gray-400"}`}
                ...
                <button
                    ref={tabRefs.Two}
                    className={`${TOGGLE_CLASSES} ${selected === "Two" ? "text-black dark:text-white" : "text-gray-600 dark:text-gray-400"}`}
                ...
                <button
                    ref={tabRefs.Three}
                    className={`${TOGGLE_CLASSES} ${selected === "Three" ? "text-black dark:text-white" : "text-gray-600 dark:text-gray-400"}`}
