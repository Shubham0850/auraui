...
```js copy filename="components/ui/placeholders-and-vanish-input.tsx"
"use client";
...
| :------------------- | :------------------------------------------------------: | ----------------------------------------------------------------------: |
| `Placeholders{:jsx}` |                     `string[]{:jsx}`                     | An array of strings used as placeholders that cycle in the input field. |
| `onChange{:jsx}`     | `(e: React.ChangeEvent<HTMLInputElement>) => void{:jsx}` |                           Function called when the input value changes. |
| `onSubmit{:jsx}`     |  `(e: React.FormEvent<HTMLFormElement>) => void{:jsx}`   |                             Function called when the form is submitted. |
