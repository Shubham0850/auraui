...
<Tabs items={['Preview', 'Code']} previewLink='/preview/feature/payments' >
...
<Tabs items={['Preview', 'Code']} previewLink='/preview/feature/development' >
   <TabComponent label="Preview">
{/* ![Hello](/contact.png) */}
...
<Tabs items={['Preview', 'Code']} previewLink='/preview/feature/aestheticdev' >
   <TabComponent label="Preview">
{/* ![Hello](/contact.png) */}
...
<Tabs items={['Preview', 'Code']} previewLink='/preview/feature/simplepayment'  >
   <TabComponent label="Preview">
{/* ![Hello](/contact.png) */}
...
<Tabs items={['Preview', 'Code']} previewLink='/preview/feature/bussiness' >
   <TabComponent label="Preview">
{/* ![Hello](/contact.png) */}
