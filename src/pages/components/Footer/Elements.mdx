...
import One from "@/components/Footer/One";
import Two from "@/components/Footer/Two";
import Three from "@/components/Footer/Three";
import Four from "@/components/Footer/Four";
import Five from "@/components/Footer/Five";
