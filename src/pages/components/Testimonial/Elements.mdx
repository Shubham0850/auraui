...
<Tabs items={['Preview', 'Code']}  previewLink='/preview/testimonial/designer' >
...
<Tabs items={['Preview', 'Code']}  previewLink='/preview/testimonial/twitter' >
   <TabComponent label="Preview">
      <Devlopers />
...
<Tabs items={['Preview', 'Code']} previewLink='/preview/testimonial/devs'  >
   <TabComponent label="Preview">
      <Devs />
...
<Tabs items={['Preview', 'Code']} previewLink='/preview/testimonial/jobs'  >
   <TabComponent label="Preview">
      <Jobs />
...
<Tabs items={['Preview', 'Code']} previewLink='/preview/testimonial/business'  >
   <TabComponent label="Preview">
      <Buisness />
