...
<Tabs items={['Preview', 'Code']}  previewLink='/preview/header/cart'>
...
<Tabs items={['Preview', 'Code']} previewLink='/preview/header/with-cta' >
   <TabComponent label="Preview">
{/* ![Hello](/contact.png) */}
...
<Tabs items={['Preview', 'Code']}  previewLink='/preview/header/simple'>
...
<Tabs items={['Preview', 'Code']} previewLink='/preview/header/with-shadow' >
   <TabComponent label="Preview">
{/* ![Hello](/contact.png) */}
...
<Tabs items={['Preview', 'Code']}  previewLink='/preview/header/bg-image'>
   <TabComponent label="Preview">
{/* ![Hello](/contact.png) */}
