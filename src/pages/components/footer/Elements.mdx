...
<Tabs items={['Preview', 'Code']} previewLink='/preview/footer/aura-footer'  >
...
<Tabs items={['Preview', 'Code']} previewLink='/preview/footer/small' >
   <TabComponent label="Preview">
{/* ![Hello](/contact.png) */}
...
// Common anchor styles
const anchorStyles =
"text-sm text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80";
...
© Copyright 2024 Aura UI
          ...
          <div className="items-center mt-8 xl:mt-0 xl:flex xl:justify-end xl:space-x-8">
            <ul className="flex flex-wrap items-center justify-center gap-x-8 gap-y-3 xl:justify-end">
              ...
              <li>
                <a href="#" title="Services" className={anchorStyles}>
                  Services
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="#" title="Support" className={anchorStyles}>
                  Support
                </a>
              </li>
            </ul>
